...
def main() -> None:
    ...
    print(f"\n{'=' * 64}")
    print("  Bootstrap Image Staging Bundle Built")
    print(f"{'=' * 64}")
    ...
    print(f"\n{'!' * 64}")
    print("  !! SINGLE-USE INSTALL PASSPHRASE — RECORD THIS NOW !!")
    print(f"{'!' * 64}")
    print("")
    print(f"    {passphrase}")
    print("")
    print("  This passphrase is the answer.toml root-password for the automated")
    print("  Proxmox installer. It will NOT be stored anywhere by broodforge.")
    print("  Write it down or store it in a secure location BEFORE using the media.")
    print("  It is replaced by a KeePass-managed credential during forge phase-03.")
    print(f"{'!' * 64}")
    print("\n  This is a STAGING BUNDLE, not a bootable ISO.")
    print("  Extract it and read iso-staging/README.md for how to combine it with")
    print("  the official Proxmox VE ISO to produce bootable media.")
    print()
    ...
    if state_path is not None:
        ...
        print("  may join the cell. Run:")
        print("    python3 authorize-spawn-media-join.py \\")
        print(f"        --state {state_path} \\")
        print(f"        --bundle {bundle_name} \\")
        print("        --operator <your-name>")
        print()
